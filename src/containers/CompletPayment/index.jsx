...
const STATUS_CONTENT_MAP = {
  succeeded: {
    text: "Pagamentto realizado com sucesso!",
    iconColor: "#30B130",
    icon: SuccessIcon,
...
export function CompletPayment() {
  ...
  return (
    <div id="payment-status">
      ...
      {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details" rel="noopener noreferrer" target="_blank">Visualizar detalhes
